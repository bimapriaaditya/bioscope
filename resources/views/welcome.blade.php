...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="antialiased">
    <div class="flex justify-center">
      <div class="w-1/2 border shadow-sm">
        <div class="flex">
          <div class="flex-none w-48 relative">
            <img src="https://images.unsplash.com/photo-1544022613-e87ca75a784a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1868&q=80" alt="" class="absolute inset-0 w-full h-full object-cover" />
          </div>
